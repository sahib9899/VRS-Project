...
<head>
     ...
     <title>Blog-post | Vehicle Rental Service</title>
     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">Get updated about all the latest and upcoming motors just by reading our daily blogs.</p>
               </div>
          </div>
     </section>
          ...
          <div class="container">
               <div class="row">
                    <div class="col-lg-3 pull-right col-xs-12">
                         ...
                         <ul class="list">
                              <li><a href="blog-post-details.php">Lorem ipsum dolor sit amet, consectetur adipisicing.</a></li>
                              <li><a href="blog-post-details.php">Et animi voluptatem, assumenda enim, consectetur quaerat!</a></li>
                              <li><a href="blog-post-details.php">Ducimus magni eveniet sit doloremque molestiae alias mollitia vitae.</a></li>
                         </ul>
                    </div>
