     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">Want a Commute partner in City? Here you Go </p>
               </div>
          </div>
     </section>
               ...
               <div class="row">
                         ...
                         <div class="courses-thumb courses-thumb-secondary">
                              <div class="courses-top">
                                   ...
                                   <div class="courses-date">
                                        ...
                                        <span title="Engine"><i class="fa fa-sign-out"></i> 100cc</span>
                                        <span title="Gear"><i class="fa fa-cog"></i> 4</span>
                                   </div>
                              </div>

                              <div class="courses-detail">
                                   <h3><a href="fleet.php">Hero : Splendor</a></h3>
                                   <p class="lead"><small>from</small> <strong>₹600</strong> <small>per 24 hours</small></p>
                                   <p>Hero Splendor is best city ride for 2 person.</p>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              <div class="courses-top">
                                   <div class="courses-image">
                                        <img src="images/bike2.jpg" class="img-responsive" alt="">
                                   </div>
                                   <div class="courses-date">
                                        <span title="passegengers"><i class="fa fa-user"></i> 2</span>
                                        <span title="luggages"><i class="fa fa-briefcase"></i>2</span>
                                        <span title="Engine"><i class="fa fa-sign-out"></i> 100cc</span>
                                        <span title="Gear"><i class="fa fa-cog"></i>N</span>
                                   </div>
                              </div>

                              <div class="courses-detail">
                                   <h3><a href="fleet.php">Honda : Activa 6G</a></h3>
                                   <p class="lead"><small>from</small> <strong>₹700</strong> <small>per 24 hours</small></p>
                                   <p>Honda Activa is the Easy to ride vehicle for city commute.</p>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              <div class="courses-top">
                                   <div class="courses-image">
                                        <img src="images/bike3.jpg" class="img-responsive" alt="">
                                   </div>
                                   <div class="courses-date">
                                        <span title="passegengers"><i class="fa fa-user"></i> 2</span>
                                        <span title="luggages"><i class="fa fa-briefcase"></i> 2</span>
                                        <span title="Engine"><i class="fa fa-sign-out"></i> 125cc</span>
                                        <span title="Gear"><i class="fa fa-cog"></i> 5</span>
                                   </div>
                              </div>

                              <div class="courses-detail">
                                   <h3><a href="fleet.php">Honda : CB Shine</a></h3>
                                   <p class="lead"><small>from</small> <strong>₹950</strong> <small>per 24 hours</small></p>
                                   <p>Need a long Commute in city? get this without a doubt.</p>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              <div class="courses-top">
                                   <div class="courses-image">
                                        <img src="images/bike4.jpg" class="img-responsive" alt="">
                                   </div>
                                   <div class="courses-date">
                                        <span title="passegengers"><i class="fa fa-user"></i> 2</span>
                                        <span title="luggages"><i class="fa fa-briefcase"></i> 2</span>
                                        <span title="Engine"><i class="fa fa-sign-out"></i> 350cc</span>
                                        <span title="Gear"><i class="fa fa-cog"></i> 5</span>
                                   </div>
                              </div>

                              <div class="courses-detail">
                                   <h3><a href="fleet.php">Royal Enfield : Classic 350</a></h3>
                                   <p class="lead"><small>from</small> <strong>₹1500</strong> <small>per 24 hours</small></p>
                                   <p> Hey Touring Lovers! We got your Dream here..</p>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              <div class="courses-top">
                                   <div class="courses-image">
                                        <img src="images/bike6.jpg" class="img-responsive" alt="">
                                   </div>
                                   <div class="courses-date">
                                        <span title="passegengers"><i class="fa fa-user"></i> 2</span>
                                        <span title="luggages"><i class="fa fa-briefcase"></i> 2</span>
                              ...
                              <div class="courses-detail">
                                   <h3><a href="fleet.php">Suzuki : Burgman 125</a></h3>
                                   <p class="lead"><small>from</small> <strong>₹950</strong> <small>per 24 hours</small></p>
                                   <p>Want a Powerfull but Gearless vehicle? Here you go.</p>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              <div class="courses-top">
                                   <div class="courses-image">
                                        <img src="images/bike5.jpg" class="img-responsive" alt="">
                                   </div>
                                   <div class="courses-date">
                                        <span title="passegengers"><i class="fa fa-user"></i> 1</span>
                                        <span title="luggages"><i class="fa fa-briefcase"></i> 1</span>
                                        <span title="Engine"><i class="fa fa-sign-out"></i> 200ccc</span>
                                        <span title="Gear"><i class="fa fa-cog"></i> 5</span>
                                   </div>
                              </div>

                              <div class="courses-detail">
                                   <h3><a href="fleet.php">KTM : RC 200</a></h3>
                                   <p class="lead"><small>from</small> <strong>₹1500</strong> <small>per 24 hours.</small></p>
                                   <p>For the all Speed Lovers out there..</p>
                              </div>
